...
namespace SmartPS.ViewModels.UserManagement;
...
public class UserManagementViewModel : ViewModelBase
{
    ...
    // Form tạo tài khoản mới (Two-Way Data Binding chuẩn MVVM)
    ...
    private async Task ExecuteCreateUserAsync()
    {
        ...
        try
        {
            ...
            if (success)
            {
                _dialogService.ShowSuccess(
                    _localizationService.GetString("Msg_CreateUser_Success", request.Username, request.FullName));
        ...
        catch (Exception ex)
        {
            ...
            {
                _dialogService.ShowError(_localizationService.GetString("Msg_CreateUser_Error", ex.Message));
            }
        }
        finally
        {
    ...
    private async Task ExecuteEditUserAsync(object? parameter)
    {
        ...
        try
        {
            var result = await _dialogService.ShowEditUserDialogAsync(user, AvailableRoles);
        ...
        catch (Exception ex)
        {
            ...
            {
                _dialogService.ShowError(_localizationService.GetString("Msg_EditUser_Error", ex.Message));
            }
        }
    }
    ...
    private async Task ExecuteDeleteUserAsync(object? parameter)
    {
        ...
        var confirm = _dialogService.ShowYesNo(
        ...
        if (confirm)
        {
            try
            {
                ...
                if (success)
                {
                    _dialogService.ShowSuccess(_localizationService.GetString("Msg_DeleteUser_Success", user.Username));
                    await LoadDataAsync();
                }
                else
                {
            ...
            catch (Exception ex)
            {
                ...
                {
                    _dialogService.ShowError(_localizationService.GetString("Msg_LoadData_Error", ex.Message));
                }
            }
            finally
            {
